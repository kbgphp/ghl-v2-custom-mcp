...
import { z } from "zod";
import { searchContactsTool, readContactWithCustomFieldsTool, updateContactFieldsTool, createContactTool } from "./tools/contacts.js";
...
export function createMCPServer() {
    ...
    // 1. Search Contacts
    server.tool(searchContactsTool.name, searchContactsTool.description, {
    ...
    server.tool(readContactWithCustomFieldsTool.name, readContactWithCustomFieldsTool.description, {
    ...
    server.tool(updateContactFieldsTool.name, updateContactFieldsTool.description, {
    ...
    // 4. Create Contact
    server.tool(createContactTool.name, createContactTool.description, {
    ...
    // 5. Read Tags
    server.tool(readTagsTool.name, readTagsTool.description, {
    ...
    // 6. Apply Tags
    server.tool(applyTagsTool.name, applyTagsTool.description, {
    ...
    server.tool(readWorkflowConfigurationTool.name, readWorkflowConfigurationTool.description, {
    ...
    server.tool(readCalendarConfigurationTool.name, readCalendarConfigurationTool.description, {
    ...
    server.tool(readCustomFieldDefinitionsTool.name, readCustomFieldDefinitionsTool.description, {
        locationId: z.string().optional().describe("Optional sub-account location ID")
    }, async (args) => {
        try {
