...
export const readCalendarConfigurationTool = {
    ...
    description: "Read calendar and appointment configurations in the GoHighLevel sub-account, including slot duration, availability schedules, round-robin team members, and booking settings.",
    parameters: z.object({
        calendarId: z
            .string()
            .optional()
