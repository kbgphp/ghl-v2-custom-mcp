...
export const readWorkflowConfigurationTool = {
  ...
  description:
    "Read automation workflow configurations in the GoHighLevel sub-account, including trigger conditions, step actions (SMS, emails, wait steps, webhooks), active statuses, and execution stats.",
  parameters: z.object({
    workflowId: z
      .string()
      .optional()
  ...
  execute: async (args: { workflowId?: string; locationId?: string }) => {
